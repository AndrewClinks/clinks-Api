...
class PaymentCreateSerializer(CreateModelSerializer):
    ...
    def payment_validation(self, attrs):
        ...
        payment_intent = StripePayment.charge(self, payment_intent_id, lambda: StripePayment.create_payment_intent(total, currency, "Payment for order", card.stripe_payment_method_id,  company.stripe_account_id, application_fee_amount=application_fee, stripe_customer_account_id=card.customer.stripe_customer_id),
